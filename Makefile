...
################################################################################
# infra-reporting-* make targets (under playbooks/infra/reporting)
################################################################################
# infra-reporting-bootstrap
# infra-reporting-reset-collections-reqs
# infra-reporting-clean-caches
# infra-reporting-gendata
# infra-reporting-render
# infra-reporting-run-playbook
# infra-reporting-pylint
# infra-reporting-ansible-lint
# infra-reporting-shellcheck
# infra-reporting-lint
# infra-reporting-pytest
# infra-reporting-test-verify
# infra-reporting-test
# infra-reporting-retest
infra-reporting-%:
	# The recipe for the rule.
	# It runs the sub-make in a subshell to avoid changing the current directory.
	@echo "--- Forwarding target '$(*)' to playbooks/infra/reporting ---"
	@(cd playbooks/infra/reporting && $(MAKE) $(*) )
